 ...
 *
 * Both bodies live in TS source so they're tree-shaken alongside the daemon
 * and ship as one binary. Cache-Control: no-store because the dashboard is
 * a single-user dev tool, not a CDN edge.
 */
