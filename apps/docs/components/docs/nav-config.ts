  ...
  groups: [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Brand Logo", href: "/docs/components/brand-logo", status: "shipped" },
        ...
        { title: "Empty State Illustration", href: "/docs/components/empty-state-illustration", status: "shipped" },
        ...
        { title: "Widget Shell", href: "/docs/components/widget-shell", status: "shipped" },
      ],
    },
    {
      title: "Charts",
