...
export type MarketingPricingDetailFilledProps = { className?: string }

/**
 * MarketingPricingDetailFilled — Add Product wizard, Step 2/5 with price filled.
 * Ported from AlignUI Pro Figma node `164914:73642`.
 */
export function MarketingPricingDetailFilled({ className }: MarketingPricingDetailFilledProps) {
  return (
      ...
      <FieldGroup>
        <Field>
          ...
          <InputRoot>
            ...
            <Input id="prod-price" defaultValue="478.80" />
          </InputRoot>
          <FieldDescription>
