    ...
    <SonnerToaster
      ...
      toastOptions={{
        ...
        classNames: {
          ...
          toast:
            "group pointer-events-auto flex items-center gap-2 w-full bg-bg-white-0 text-text-strong-950 border border-stroke-soft-200 rounded-[10px] py-2 px-2.5 shadow-(--shadow-tooltip)",
...
function callFilled(
  ...
  return toast(message, {
    ...
    classNames: {
      toast: `${filledBgVar[status]} text-static-white border-transparent rounded-[10px] py-2 px-2.5 shadow-(--shadow-tooltip)`,
