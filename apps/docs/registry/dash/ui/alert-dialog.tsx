 ...
 *   - was rounded-2xl (16) → rounded-[20px]
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    ...
    className={cn(
      "fixed inset-0 z-50 bg-[#333333]/24 backdrop-blur-sm",
  ...
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ...
      className={cn(
        ...
        "w-full max-w-md rounded-[20px] border border-stroke-soft-200 bg-bg-white-0 shadow-custom-shadows-medium",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=open]:fade-in-0 data-[state=closed]:fade-out-0",
