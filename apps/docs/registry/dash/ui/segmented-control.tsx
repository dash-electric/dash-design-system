 ...
 *  - Group (2604:114): Track 36px tall, bg-weak-50, rounded-[10px], 4px pad,
...
const segmentedRootVariants = cva(
  // Figma track: bg-weak-50, rounded-[10px], 4px pad, 4px gap between items
  "inline-flex items-center rounded-[10px] bg-bg-weak-50 p-1 gap-1",
  {
    variants: {
      size: {
        sm: "h-8",
