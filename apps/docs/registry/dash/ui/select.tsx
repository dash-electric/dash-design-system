  ...
  ),
  {
    variants: {
      ...
      size: {
        ...
        lg: "h-10 rounded-[10px] px-3 text-sm gap-2 [&_svg]:size-5",
        xl: "h-11 rounded-[10px] px-4 text-base gap-2 [&_svg]:size-5",
      },
    },
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      position={position}
      className={cn(
        "relative z-50 max-h-72 min-w-[8rem] overflow-hidden rounded-[10px] border border-stroke-soft-200 bg-bg-white-0 shadow-custom-md",
