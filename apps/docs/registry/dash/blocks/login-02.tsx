...
/**
 * Login with social SSO (Google + Apple + Microsoft) above email/password.
 */
  ...
  return (
    <form className="w-full max-w-sm space-y-5">
      <div className="space-y-1.5 text-center">
        ...
        <p className="text-sm text-text-sub-600">Pilih cara masuk yang paling cepat.</p>
      </div>

      <div className="grid grid-cols-1 gap-2">
        <SocialButton brand="google" label="Lanjut dengan Google" className="w-full" />
        <SocialButton brand="apple" label="Lanjut dengan Apple" className="w-full" />
      </div>

      <div className="relative">
        <Divider />
        <span className="absolute left-1/2 -translate-x-1/2 -top-2 bg-bg-white-0 px-3 text-xs text-text-soft-400 uppercase tracking-wider">atau</span>
      </div>
